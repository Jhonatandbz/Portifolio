...
const tecnology = [
    ...
    {   
        id: 4,
        rout: './assets/image/tecnology/ts.png',
        name: 'Type Script',
        description: 'TypeScript é uma linguagem de programação baseada em JavaScript que adiciona recursos avançados, como tipagem estática, ao desenvolvimento web. Com TypeScript, é possível identificar erros e bugs antes mesmo de executar o código, resultando em aplicativos mais confiáveis e de alta qualidade. ',
    },
    {   
        id: 5,
